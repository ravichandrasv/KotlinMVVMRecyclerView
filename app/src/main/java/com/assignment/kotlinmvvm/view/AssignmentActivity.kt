...
import com.assignment.kotlinmvvm.di.Injection
...
class AssignmentActivity : AppCompatActivity() {
    ...
    //ui
    private fun setupUI(){
        adapter= AssignmentAdapter(viewModel.museums.value?: emptyList())
    ...
    //observers
    private val renderMuseums= Observer<List<Assignment>> {
